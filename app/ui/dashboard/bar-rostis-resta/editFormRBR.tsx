...
import { editRestoBarRestaurant } from '@/app/lib/actionsFolder/rosti-bares-resta'
...
const EditFormRBR = ({
  ...
  const editRestoBarRestaurantByID = editRestoBarRestaurant.bind(null, idToEdit)
  const [state, dispatch] = useFormState(
    editRestoBarRestaurantByID,
    initialState
  )
  const formItems = [
    {
  ...
  return (
    <form action={dispatch} className="my-4" autoComplete="off">
              ...
              <div className="relative mt-2 rounded-md">
                <div className="relative">
                  <input
                    ...
                    defaultValue={defaultData[formItem.field]}
                  />
                </div>
              </div>
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">Editar RBR</Button>
      </div>
    </form>
  )
}

export default EditFormRBR
