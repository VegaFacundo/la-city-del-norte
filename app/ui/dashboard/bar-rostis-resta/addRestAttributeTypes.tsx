...
const AddRestAttributeTypes = ({
  allRestAttributesTypes,
  idToEdit,
}: {
  allRestAttributesTypes: {
    id: number
    ...
    <form action={dispatch} className="flex flex-wrap">
      <div className="relative  w-72 min-w-[200px] pb-2">
        <select
          ...
          name="id_rest_attributes_types"
        >
          {allRestAttributesTypes &&
            allRestAttributesTypes.map((allRestAttributesType, index) => {
              return (
                <option
                  key={`add-food-type-${index}-${allRestAttributesType.name}`}
                  value={allRestAttributesType.id}
                  id="id_rest_attributes_types"
                >
                  {allRestAttributesType.name}
                </option>
              )
            })}
        </select>
...
export default AddRestAttributeTypes
